...
export function SummaryStep({ data, onPrev }: Props) {
  ...
  return (
    <div>
      <h2 className="text-3xl font-bold text-gray-900 mb-2">Your House Estimation Summary</h2>
      <p className="text-gray-600 mb-8">Review your complete house building cost estimate</p>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="font-semibold text-gray-900">{data.user.location}</p>
            </div>
          </div>
        </div>

        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <h3 className="text-xl font-bold text-gray-900 mb-4">Land Details</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <p className="text-sm text-gray-600">Land Size</p>
              <p className="font-semibold text-gray-900">{data.perches} Perches</p>
            </div>
            <div>
              <p className="text-sm text-gray-600">Total Land Area</p>
              <p className="font-semibold text-gray-900">{totalLandSqft.toLocaleString()} sqft</p>
            </div>
            <div>
              <p className="text-sm text-gray-600">Buildable Area (60%)</p>
              <p className="font-semibold text-gray-900">{usableLandSqft.toLocaleString()} sqft</p>
            </div>
          </div>
        </div>

        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <h3 className="text-xl font-bold text-gray-900 mb-4">House Details</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <p className="text-sm text-gray-600">Number of Stories</p>
              <p className="font-semibold text-gray-900">{data.stories} Story</p>
            </div>
            <div>
              <p className="text-sm text-gray-600">Total Construction Area</p>
              <p className="font-semibold text-gray-900">{totalSqft.toLocaleString()} sqft</p>
            </div>
            <div>
              <p className="text-sm text-gray-600">Remaining Space</p>
              <p className="font-semibold text-gray-900">{remainingSqft.toLocaleString()} sqft</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center pb-3 border-b border-gray-200">
              <span className="text-gray-700">Construction Cost</span>
              <span className="font-semibold text-gray-900">LKR {constructionCost.toLocaleString()}</span>
            </div>
            <div className="flex justify-between items-center pb-3 border-b border-gray-200">
              <span className="text-gray-700">Roof Type: {getRoofName()}</span>
